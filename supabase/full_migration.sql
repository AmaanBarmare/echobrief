...
-- ============ v2_bot_schema.sql ============
-- EchoBrief v2 — Additional schema changes

-- 1. Add recording_source to meetings table
ALTER TABLE meetings ADD COLUMN IF NOT EXISTS recording_source TEXT DEFAULT 'extension' CHECK (recording_source IN ('extension', 'recall'));
ALTER TABLE meetings ADD COLUMN IF NOT EXISTS preferred_language TEXT DEFAULT 'en';

-- 2. WhatsApp messages table — delivery tracking
...
-- 6. Update meetings table to support platform tracking
